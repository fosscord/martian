...
* [A full list of permission nodes can be found on the docs reference page](/Martian/docs/reference)
*/
class Permission extends Base {
    ...
    * @arg {String} permission The name of the permission. [A full list of permission nodes can be found on the docs reference page](/Martian/docs/reference)
