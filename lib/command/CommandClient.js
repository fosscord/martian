...
/**
* Represents an Martian client with the command framework
* @extends Client
...
class CommandClient extends Client {
    ...
    * @arg {Object} options Martian options (same as Client)
    ...
    * @arg {String} [commandOptions.description="An Martian-based Discord bot"] The description to show in the default help command
    ...
    */
    constructor(token, options, commandOptions) {
        ...
        this.commandOptions = Object.assign({
            ...
            description: "An Martian-based Discord bot",
            ignoreBots: true,
            ignoreSelf: true,
            name: null,
